...
saveRDS(LcMCMC_samples, file = "CaseStudy-Cowen2017/Combined Likelihood/Lj-results-phi_t_p_t_100k.RDS")

library(ggmcmc)
ggmcmc::ggs_traceplot(ggs(LcMCMC_samples$samples)) + facet_wrap(ncol = 4, facets = "Parameter", scales="free")
